...
public class login 
{
    ...
    p1.setLayout(null);
     ...
     //i1= new JLabel(new ImageIcon("G:\\Temp\\all\\src\\images(1).jpg"));
     i2=new JLabel(new ImageIcon("G:\\Temp\\all\\src\\zeropoint_logo.jpg"));
    ...
    //p2-student menu 
     ...
     //i1= new JLabel(new ImageIcon("G:\\image\\MSRIT_Golden_Jubilee_Logo.png"));
     i2=new JLabel(new ImageIcon("G:\\Temp\\all\\src\\zeropoint_logo.jpg"));
